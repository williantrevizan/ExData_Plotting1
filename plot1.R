## This R file reads and substets data from given project file and makes plot1.png
...
## PLOTING PART
  ...
  png('plot1.png',width=480,height=480) # opens png device
  GAP<-hpc$Global_active_power # stores desired variable (avoid typing a lot!)
  
  ## makes histogram with desired colors, title and labels
